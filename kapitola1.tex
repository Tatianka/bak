\chapter{Základné definície a výsledky}
...
Zoberme si lookahead. Myšlienka spočíva v tom, že si chceme povedať, čo má za daným matchovaným podslovom nasledovať. Je to niečo, čo umožňuje pozrieť sa na slovo ďalej a 'nevyjedá' písmenká, čiže keď lookahead uspeje, pokračuje sa v ďalšom matchovaní od toho miesta, kde on začal pracovať. Presnejšie: slovo sa matchuje podľa regexu. Keď narazíme na lookahead, zapamätáme si toto miesto. Matchujeme podľa lookaheadu. Ak uspeje, potom sa vrátime na zapamätané miesto a pokračujeme v matchovaní regexom za lookaheadom.
...
Negatívna verzia funguje rovnako, ale otáča akceptačnú požiadavku -- namiesto toho, aby sme písali, čo nasleduje, definujeme práve to, čo nechceme aby nasledovalo. Teda negatívny lookahead 'zbehne', ak nie je schopný matchovať jeho vstup.
...
Nachádza sa tu ešte jeden rozdiel od reálneho modelu, na ktorý by sme chceli upozorniť. Regulárne výrazy sa začali využívať na vyhľadávanie v texte. V tomto kontexte má lookaround iný význam ako v teoretickom prostredí. Je pravda, že nevyjedá písmenká a preto je obľúbený aj v takých prípadoch, kedy si chceme označiť slovo $w$, ale vieme, že hľadáme slovo $v$, pričom $w$ je podslovo $v$. Teda v takom prípade môže lookahead ďaleko presahovať slovo, na ktoré sme vyhlásili zhodu. Z toho vyplýva, že my by sme na vstup nechceli dostať $w$, ale $v$. V teoretickom prostredí nás však zaujíma slovo, ktoré do jazyka patrí a na jeho okolie sa nepozeráme. Preto sa zdá, že budeme na vstupe očakávať $w$ a lookahead a lookbehind nebudú môcť presahovať dĺžku tohto slova. Táto úprava však neuškodí, nakoľko vieme z daného $w$ spraviť $v$ jednoduchým pridaním $(.*)$ na správne miesta.
