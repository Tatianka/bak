...
\def\mftitlefirst{Moderné regulárne výrazy}
\def\mftitlesecond{}
...
\begin{center}
\begin{minipage}{1\textwidth}
\textit{Ďakujem môjmu školiteľovi Michalovi Foriškovi, za vedenie práce, cenné rady a pripomienky, mojej rodine, priateľovi a blízkym priateľom za morálnu podporu. Bez~Vás by táto práca nevznikla.}
\end{minipage}
\end{center}
...
\\ \\ 
{\bf Kľúčové slová:} regulárne výrazy, pozitívny a negatívny lookaround, spätné re\-fe\-ren\-cie, regex.
%\end{center}
\end{minipage}
\end{center}
\eject % EOP v
...
\\ \\
{\bf Key words:} regular expressions, positive and negative lookaround, backreference, regex.
%\end{center}
\end{minipage}
\end{center}
\eject % EOP v
